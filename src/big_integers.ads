...
is
   ...
   function To_Big_Integer (Arg : Integer) return Big_Integer with Import;
   function To_Big_Integer (Arg : Long_Long_Integer) return Big_Integer with Import;
   ...
   function In_Range (Arg, Low, High : Big_Integer) return Boolean is
     ((Low <= Arg) and (Arg <= High)) with Import;
